...
namespace FlightManagerProject
{
    public static class StProceduresConsts
    {
        ...
        public const string GET_ALL_CUSTOMERS = "GET_ALL_CUSTOMERS";

        public const string GET_CUSTOMER_BY_USERNAME = "GET_CUSTOMER_BY_USERNAME";

        public const string REMOVE_CUSTOMER = "REMOVE_CUSTOMER";

        public const string UPDATE_CUSTOMER = "UPDATE_CUSTOMER";

        public const string ADD_AIRLINE = "ADD_AIRLINE";
